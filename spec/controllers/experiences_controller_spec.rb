...
describe ExperiencesController do
  ...
  it "should use ExperiencesController" do
    controller.should be_an_instance_of(ExperiencesController)
  end
    ...
    describe "when working with a valid item" do
      describe "POST 'create'" do
        it "should be successful" do
          ...
          Experience.any_instance.stubs(:create_url_path).returns('awesome-url-path')
        
          post 'create'
          assigns[:experience].should_not be_new_record
      ...
      describe "POST 'update'" do
        it "should be successful" do
          ...
          post 'update', :id => 1
          assigns[:experience].should be_valid
          flash[:notice].should_not be_nil
          response.should redirect_to(experiences_path)
        end
      end
