<div id="resume">
	...
	<div class="cert_icons">
		<img src="/images/ACE_Illustrator.gif" alt="Adobe Certified Expert, Illustrator" />
		<img src="/images/ACE_Photoshop.gif" alt="Adobe Certified Expert, Photoshop" />
	</div>
	...
	<ul>
		<li>
			Knowledge of computer and computer network architecture and security. Understanding of secure
			application design concepts.
		</li>
		<li>
			Experienced with use and administration of MacOS 9/X, Linux (Gentoo/Ubuntu/CentOS), NetBSD,
			OpenBSD, BeOS, Windows, Solaris.
		</li>
		<li>
		...
		<li>
			...
			VBA, PHP, Ruby / Ruby on Rails, Python.
		</li>
	</ul>
	...
	<p>
		Currently run a webserver (Gentoo Linux/PPC) with SSH, FTP, Apache, MySQL, PHP, and
		Ruby on Rails, with over 20 users and websites. Set up personal file server (Gentoo Linux/PPC)
		on home LAN for network access storage and automated daily snapshot backup of webserver.
	</p>
	<p>
		Created a fully-functional invoicing system tailored for freelance jobs with scripts for
		emailing PDFs of invoices and quotes in Filemaker Pro.
	</p>
	<p>
	...
	<p>
		Collaboration on web-based firewall frontend using PHP and BASH scripting. Designed and
		implemented module framework, then integrated into existing code. Created error handling
		and reporting framework for project.
	</p>
	<p>
	...
	<p>
		Wrote an open source program for manipulating Nintendo GameCube disc images (.gcm and .iso)
		for Linux, OSX, and Windows (under cygwin) that runs on both PPC and x86 architectures in
		ANSI C. Also wrote an open source program for extracting and injecting graphics as well as
		editing meta-data (titles) for Nintendo (NES) game ROM files. Written in ANSI C for *nix and OSX.
	</p>
	<p>
		Created several applications in Java using TCP and UDP socket communication utilizing the
		Hotline Connect and Hotline Tracker protocols including a Hotline Connect client and Hotline
